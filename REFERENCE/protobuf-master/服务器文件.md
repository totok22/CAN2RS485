...
此文档记录了目前服务器端一些相关的实际配置。文档和server_config 可能过时，以https://github.com/totok22/bitfsae_web/tree/legacy-aliyun-xin 仓库内容和配置为准。也可以直接ssh（名称：123.57.174.98）到服务器查看/home/admin/fsae_project下文件（仓库内容实际就是服务器的文件）。
